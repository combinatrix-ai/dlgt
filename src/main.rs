...
fn command_models(args: &[String]) -> Result<()> {
    ...
    let harnesses = ["codex", "claude", "cursor", "grok", "opencode", "pi"]
        .into_iter()
        .map(|harness| {
            client::call(
                "model.list",
